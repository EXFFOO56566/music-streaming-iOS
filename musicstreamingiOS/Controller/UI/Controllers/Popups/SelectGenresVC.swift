...
class SelectGenresVC: BaseVC {
   ...
   private var genresNameString:String? = ""
    ...
    private func setupUI(){
        ...
        tableView.register(R.nib.selectGenresTableCell(), forCellReuseIdentifier: R.reuseIdentifier.selectGenres_TableCell.identifier)
    }
...
extension SelectGenresVC:UITableViewDelegate,UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: R.reuseIdentifier.selectGenres_TableCell.identifier) as? SelectGenres_TableCell
