...
class SelectPriceVC: BaseVC {
    ...
    private func setupUI(){
        ...
        tableView.register(R.nib.selectPriceTableCell(), forCellReuseIdentifier: R.reuseIdentifier.selectPrice_TableCell.identifier)
    }
...
extension SelectPriceVC:UITableViewDelegate,UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: R.reuseIdentifier.selectPrice_TableCell.identifier) as? SelectPrice_TableCell
