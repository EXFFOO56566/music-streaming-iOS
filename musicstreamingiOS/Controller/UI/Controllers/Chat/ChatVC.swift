...
class ChatVC: BaseVC {
    ...
    private func setupUI(){
        ...
        tableView.register(R.nib.chatTableItem(), forCellReuseIdentifier: R.reuseIdentifier.chatTableItem.identifier)
    }
...
extension ChatVC: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: R.reuseIdentifier.chatTableItem.identifier, for: indexPath) as! ChatTableItem
