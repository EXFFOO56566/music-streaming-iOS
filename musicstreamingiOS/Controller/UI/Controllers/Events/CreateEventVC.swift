...
class CreateEventVC: BaseVC {
    ...
    private func setupUI(){
        self.tableView.register(R.nib.createEventTableItem(), forCellReuseIdentifier: R.reuseIdentifier.createEventTableItem.identifier)
    }
...
extension CreateEventVC:UITableViewDelegate,UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: R.reuseIdentifier.createEventTableItem.identifier) as? CreateEventTableItem
        cell?.vc = self
        cell?.bind(object)
        return cell!
    }
