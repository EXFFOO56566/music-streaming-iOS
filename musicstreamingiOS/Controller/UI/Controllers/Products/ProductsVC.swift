...
class ProductsVC: BaseVC {
    ...
    override func viewDidLoad() {
        ...
        table.register( R.nib.expandableTextTableItem(), forCellReuseIdentifier: R.reuseIdentifier.expandableTextTableItem.identifier)
        table.register( R.nib.expandableProfileTableItem(), forCellReuseIdentifier: R.reuseIdentifier.expandableProfileTableItem.identifier)
        table.register( R.nib.expandableReviewTableItem(), forCellReuseIdentifier: R.reuseIdentifier.expandableReviewTableItem.identifier)
    }
...
extension ProductsVC:ExpyTableViewDataSource,ExpyTableViewDelegate{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 1:
            ...
            return cell
        case 2:
            let cell = table.dequeueReusableCell(withIdentifier: R.reuseIdentifier.expandableTextTableItem.identifier) as! ExpandableTextTableItem
            cell.selectionStyle = .none
            ...
            return cell
        case 3:
            let cell = table.dequeueReusableCell(withIdentifier: R.reuseIdentifier.expandableReviewTableItem.identifier) as! ExpandableReviewTableItem
            cell.selectionStyle = .none
        ...
        case 4:
            ...
            return cell
        case 5:
            let cell = table.dequeueReusableCell(withIdentifier: R.reuseIdentifier.expandableProfileTableItem.identifier) as! ExpandableProfileTableItem
            cell.selectionStyle = .none
