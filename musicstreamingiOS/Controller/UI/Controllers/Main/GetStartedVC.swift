...
class GetStartedVC: UIViewController,UIScrollViewDelegate {
    ...
    private func createSlides() -> [IntroItem] {
        ...
        slide1.imageLabel.image = UIImage(named: "Onboarding_icon1")
        slide1.firstLabel.text = (NSLocalizedString("Music", comment: ""))
        slide1.secondLabel.text = (NSLocalizedString("Listen Music Everywhere,Anytime", comment: ""))
        ...
        slide2.imageLabel.image = UIImage(named: "Onboarding_icon2")
        slide2.firstLabel.text = (NSLocalizedString("Playlist", comment: ""))
        slide2.secondLabel.text = (NSLocalizedString("Create Playlist with any song, On-The-Go", comment: ""))
        ...
        slide3.imageLabel.image = UIImage(named: "Onboarding_icon3")
        slide3.firstLabel.text = NSLocalizedString("Calling all creators", comment: "")
        slide3.secondLabel.text = NSLocalizedString("Get on to connect with fans, share your sounds, and grow your audience", comment: "")
    ...
    func scrollViewDidScroll(_ scrollView: UIScrollView) {
        ...
        if pageControl.currentPage == 0{
            ...
            self.scrollNextBtn.setImage(R.image.intro_forward(), for: .normal)
