...
class IntroVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.discoverLabel.text = NSLocalizedString("Discover,Stream, and share a constantly expanding mix of music from emerging and major artists around the world.", comment: "")
