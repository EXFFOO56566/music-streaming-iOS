...
class GenresVC: BaseVC {
    ...
    private func setupUI(){
        ...
        collectionView.register(R.nib.genresCollectionCell(), forCellWithReuseIdentifier: R.reuseIdentifier.genres_CollectionCell.identifier)
    }
    private func save(){
...
extension GenresVC:UICollectionViewDelegate,UICollectionViewDataSource{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: R.reuseIdentifier.genres_CollectionCell.identifier, for: indexPath) as? Genres_CollectionCell
        cell?.delegate = self
