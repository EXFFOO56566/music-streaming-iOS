...
class LatestDownloadVC: BaseVC {
    ...
    private func setupUI(){
        ...
        tableView.register(R.nib.latestDownloadTableCell(), forCellReuseIdentifier: R.reuseIdentifier.latestDownload_TableCell.identifier)
    }
...
extension LatestDownloadVC:UITableViewDelegate,UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if self.downloadSongsArray.count == 0{
            ...
            let cell = tableView.dequeueReusableCell(withIdentifier: R.reuseIdentifier.latestDownload_TableCell.identifier) as? LatestDownload_TableCell
            cell?.selectionStyle = .none
