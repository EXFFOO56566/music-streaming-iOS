...
class RecentlyPlayedVC: BaseVC {
    ...
    private func setupUI(){
        ...
        tableView.register(R.nib.recentlyPlayedTableCell(), forCellReuseIdentifier: R.reuseIdentifier.recentlyPlayed_TableCell.identifier)
...
extension RecentlyPlayedVC:UITableViewDelegate,UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if self.RecentlyPlayedArray.count == 0{
            ...
            let cell = tableView.dequeueReusableCell(withIdentifier: R.reuseIdentifier.recentlyPlayed_TableCell.identifier) as? RecentlyPlayed_TableCell
            cell?.selectionStyle = .none
            cell?.vc = self
