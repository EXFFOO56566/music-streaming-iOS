...
class PurchasesVC: BaseVC {
    ...
    private func setupUI(){
        ...
        tableView.register(R.nib.purchaseTableItem(), forCellReuseIdentifier: R.reuseIdentifier.purchaseTableItem.identifier)
                    ...
                    if success != nil{
                        Async.main({
                            self.dismissProgressDialog {
                                ...
                                self.purchasesArray = success?.data?.data ?? []
...
extension PurchasesVC:UITableViewDelegate,UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if self.purchasesArray.count == 0{
            ...
            let cell = tableView.dequeueReusableCell(withIdentifier: R.reuseIdentifier.purchaseTableItem.identifier) as? PurchaseTableItem
            cell?.selectionStyle = .none
