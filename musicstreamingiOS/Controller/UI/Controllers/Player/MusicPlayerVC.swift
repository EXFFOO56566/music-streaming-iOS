...
class MusicPlayerVC: BaseVC {
    ...
    override func viewDidLoad() {
        ...
        popupItem.rightBarButtonItems = [ pause,cancel ]
    ...
    func setup(){
        ...
        self.circularView.cornerRadiusV = self.circularView.frame.height / 2
        self.thumbnailImage.cornerRadiusV = self.thumbnailImage.frame.height / 2
        ...
        self.musicTypeLabel.text = self.musicArray[currentAudioIndex].musicType ?? ""
        ...
        if (self.musicArray[currentAudioIndex].isLiked!) {
            likeBtn.setImage(R.image.ic_heartRed(), for: .normal)
        }else{
            likeBtn.setImage(R.image.ic_heartOutlinePlayer(), for: .normal)
        }
                        ...
                        Async.main({
                            self.dismissProgressDialog {
                                ...
                                if success?.mode == "disliked"{
                                    self.likeBtn.setImage(R.image.ic_heartOutlinePlayer(), for: .normal)
                                }else{
                                    self.likeBtn.setImage(R.image.ic_heartRed(), for: .normal)
                                }
                            }
                        })
                    ...
                    if success != nil{
                        Async.main({
                            self.dismissProgressDialog {
                                log.debug("success = \(success?.mode ?? "")")
                                if success?.mode == "disliked"{
                                    self.dislikeBtn.setImage(R.image.dislikePlayerColored(), for: .normal)
                                }else{
                                    self.dislikeBtn.setImage(R.image.dislikePlayer(), for: .normal)
                                }
                            }
                        })
