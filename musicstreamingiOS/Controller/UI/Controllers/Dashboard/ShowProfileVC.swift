...
class ShowProfileVC: ButtonBarPagerTabStripViewController {
    ...
    override func viewControllers(for pagerTabStripController: PagerTabStripViewController) -> [UIViewController] {
        ...
        activitiesVC?.Activities = self.activitiesArray
        activitiesVC?.status = true
        let albumsVC = R.storyboard.dashboard.albumsVC()
        albumsVC?.albumsArray = self.albumArray
        albumsVC?.status = true
        let profileLikedVC = R.storyboard.dashboard.profileLikedVC()
        profileLikedVC?.likedArray = self.likeArray
        profileLikedVC?.status = true
        let profilePlaylistVC = R.storyboard.dashboard.profilePlaylistVC()
        profilePlaylistVC?.playlistArray = self.playlistArray
        profilePlaylistVC?.status = true
        let songVC = R.storyboard.dashboard.songVC()
        songVC?.songArray = self.songArray
        songVC?.status = true
        let storeVC = R.storyboard.dashboard.storeVC()
        storeVC?.storeArray = self.storeArray
        storeVC?.status = true
        let stationsVC = R.storyboard.dashboard.stationsVC()
        stationsVC?.stationArray = self.stationArray
        stationsVC?.status = true
