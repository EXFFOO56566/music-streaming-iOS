...
class PlaylistVC: BaseVC {
    ...
    override func viewDidLoad() {
        ...
        self.setupUI()
        titleLabel.title = (NSLocalizedString("PlayList", comment: "PlayList"))
        fetchPublicPlaylist()
...
//                self.navigationController?.pushViewController(vc!, animated: true)
    ...
    private func setupUI(){
        ...
        self.tableView.register(R.nib.playListSectionOneTableItem(), forCellReuseIdentifier: R.reuseIdentifier.playListSectionOneTableItem.identifier)
        self.tableView.register(R.nib.playListSectionTwoTableItem(), forCellReuseIdentifier: R.reuseIdentifier.playListSectionTwoTableItem.identifier)
...
extension PlaylistVC:UITableViewDelegate,UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 4:
            ...
            return cell!
        case 5:
            let cell = tableView.dequeueReusableCell(withIdentifier: R.reuseIdentifier.playListSectionTwoTableItem.identifier) as? PlayListSectionTwoTableItem
            cell?.selectionStyle = .none
            cell?.vc = self
