...
class ArtistVC: BaseVC {
    ...
    private var followersArray = [ArtistModel.Datum]()
    ...
    private func setupUI(){
        ...
        followersTableView.register(R.nib.followersTableCell(), forCellReuseIdentifier: R.reuseIdentifier.followers_TableCell.identifier)
...
extension ArtistVC:UITableViewDelegate,UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: R.reuseIdentifier.followers_TableCell.identifier) as? Followers_TableCell
        cell?.delegate = self
        cell?.artistVC = self
