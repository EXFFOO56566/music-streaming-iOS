...
class PopularVC: BaseVC {
    ...
    private func setupUI(){
        ...
        tableView.register(R.nib.popularTableCell(), forCellReuseIdentifier: R.reuseIdentifier.popular_TableCell.identifier)
...
extension PopularVC:UITableViewDelegate,UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if self.popularArray != nil{
                       let cell = tableView.dequeueReusableCell(withIdentifier: R.reuseIdentifier.popular_TableCell.identifier) as? Popular_TableCell
