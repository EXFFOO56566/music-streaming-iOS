...
class UserInfoVC: BaseVC {
    ...
    private func setupUI(){
        ...
        storeCollectionView.register(R.nib.dashboardNewRelease_CollectionCell(), forCellWithReuseIdentifier: R.reuseIdentifier.dashboardNewRelease_CollectionCell.identifier)
        topSongsCollectionView.register(R.nib.dashboardNewRelease_CollectionCell(), forCellWithReuseIdentifier: R.reuseIdentifier.dashboardNewRelease_CollectionCell.identifier)
        latestSongsCollectionView.register(R.nib.dashboardNewRelease_CollectionCell(), forCellWithReuseIdentifier: R.reuseIdentifier.dashboardNewRelease_CollectionCell.identifier)
        tableView.register(R.nib.activitiesTableCell(), forCellReuseIdentifier: R.reuseIdentifier.activities_TableCell.identifier)
                    ...
                    if success != nil{
                        Async.main({
                            self.dismissProgressDialog {
                                ...
                                self.storeSongsArray = success?.data?.store ?? []
