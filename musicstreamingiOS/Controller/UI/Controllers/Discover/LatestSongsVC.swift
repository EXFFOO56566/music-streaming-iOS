...
class LatestSongsVC: BaseVC {
    ...
    private func setupUI(){
        ...
        tableView.register(R.nib.latestSongsTableCell(), forCellReuseIdentifier: R.reuseIdentifier.latestSongs_TableCell.identifier)
...
extension LatestSongsVC:UITableViewDelegate,UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if self.latestSongsArray != nil{
            let cell = tableView.dequeueReusableCell(withIdentifier: R.reuseIdentifier.latestSongs_TableCell.identifier) as? LatestSongs_TableCell
