...
//        self.tableView.isHidden = true
        ...
        tableView.register(R.nib.searchAlbumTableCell(), forCellReuseIdentifier: R.reuseIdentifier.searchAlbum_TableCell.identifier)
    }
...
extension SearchAlbumsVC:UITableViewDelegate,UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: R.reuseIdentifier.searchAlbum_TableCell.identifier) as? SearchAlbum_TableCell
        cell?.vc = self
