...
class SearchArtistVC: BaseVC {
    ...
    private func setupUI(){
        ...
        tableView.register(R.nib.searchArtistTableCell(), forCellReuseIdentifier: R.reuseIdentifier.searchArtist_TableCell.identifier)
    }
...
extension SearchArtistVC:UITableViewDelegate,UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: R.reuseIdentifier.searchArtist_TableCell.identifier) as? SearchArtist_TableCell
        cell?.vc = self
        cell?.delegate = self
...
//        cell?.timeLabel.text = object.registered ?? ""
        return cell!
