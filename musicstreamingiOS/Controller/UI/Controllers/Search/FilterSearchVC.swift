...
class FilterSearchVC: UIViewController {
    ...
    private func setupUI(){
        tableView.register(R.nib.selectFilterTableCell(), forCellReuseIdentifier: R.reuseIdentifier.selectFilter_TableCell.identifier)
    }
...
extension FilterSearchVC:UITableViewDataSource,UITableViewDelegate{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: R.reuseIdentifier.selectFilter_TableCell.identifier) as? SelectFilter_TableCell
