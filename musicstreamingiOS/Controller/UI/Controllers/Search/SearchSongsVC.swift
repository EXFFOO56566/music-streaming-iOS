...
//        self.tableView.isHidden = true
        ...
        tableView.register(R.nib.searchSongTableCell(), forCellReuseIdentifier: R.reuseIdentifier.searchSong_TableCell.identifier)
    }
...
extension SearchSongsVC:UITableViewDelegate,UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: R.reuseIdentifier.searchSong_TableCell.identifier) as? SearchSong_TableCell
