...
class SettingVC1: UIViewController {
    ...
    private func setupUI(){
        ...
        tableView.register(R.nib.settingsTableCell(), forCellReuseIdentifier: R.reuseIdentifier.settings_TableCell.identifier)
...
extension SettingVC1: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 0:
            ...
            case 0:
                let cell = tableView.dequeueReusableCell(withIdentifier: R.reuseIdentifier.settings_TableCell.identifier) as! Settings_TableCell
