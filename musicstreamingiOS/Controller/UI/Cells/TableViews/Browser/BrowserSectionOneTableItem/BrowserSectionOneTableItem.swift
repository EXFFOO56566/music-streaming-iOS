...
class BrowserSectionOneTableItem: UITableViewCell {
    ...
    func setupUI(){
        ...
        collectionView.register(R.nib.browseCollectionCell(), forCellWithReuseIdentifier: R.reuseIdentifier.browse_CollectionCell.identifier)
       }
...
extension BrowserSectionOneTableItem:UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: R.reuseIdentifier.browse_CollectionCell.identifier, for: indexPath) as? Browse_CollectionCell
