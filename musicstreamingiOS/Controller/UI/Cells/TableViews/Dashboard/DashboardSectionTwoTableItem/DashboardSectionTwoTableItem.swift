...
class DashboardSectionTwoTableItem: UITableViewCell {
    ...
    func setupUI(){
        ...
        collectionView.register(R.nib.dashboardSectionTwoCollectionItem(), forCellWithReuseIdentifier: R.reuseIdentifier.dashboardSectionTwoCollectionItem.identifier)
    }
