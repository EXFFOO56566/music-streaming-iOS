...
class DashboardSectionOneTableItem: UITableViewCell {
    ...
    func setupUI(){
        ...
        collectionView.register(R.nib.dashboardSectionOneCollectionItem(), forCellWithReuseIdentifier: R.reuseIdentifier.dashboardSectionOneCollectionItem.identifier)
    }
...
extension DashboardSectionOneTableItem:UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        if self.loggedInVC != nil{
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: R.reuseIdentifier.dashboardSectionOneCollectionItem.identifier, for: indexPath) as? DashboardSectionOneCollectionItem
