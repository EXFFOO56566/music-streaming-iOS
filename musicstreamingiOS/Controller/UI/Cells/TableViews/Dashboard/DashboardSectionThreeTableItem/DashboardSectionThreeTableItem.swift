...
class DashboardSectionThreeTableItem: UITableViewCell {
    ...
    func setupUI(){
        ...
        collectionView.register(R.nib.dashboardNewRelease_CollectionCell(), forCellWithReuseIdentifier: R.reuseIdentifier.dashboardNewRelease_CollectionCell.identifier)
    }
