//
//  DashboardSectionFourTableItem.swift
//  DeepSoundiOS
//
...
import DeepSoundSDK
class DashboardSectionFourTableItem: UITableViewCell {

    @IBOutlet weak var collectionView: UICollectionView!
    var object : DiscoverModel.NewReleasesRecentlyPlayed?
    ...
    func setupUI(){
         ...
         collectionView.register(R.nib.dashboardRecentlyPlayedCollectionCell(), forCellWithReuseIdentifier: R.reuseIdentifier.dashboardRecentlyPlayed_CollectionCell.identifier)
     }
...
extension DashboardSectionFourTableItem:UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout{
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return self.songObject.count ?? 0
    }
